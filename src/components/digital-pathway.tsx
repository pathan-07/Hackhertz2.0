...
export const DigitalPathway = () => {
  ...
  useEffect(() => {
    ...
    const drawDigitalPathway = () => {
      ...
      // Add some glowing particles along the path
      const particleCount = 20;
      
      for (let i = 0; i < particleCount; i++) {
        // Random horizontal position
        const particleX = vanishingPointX + (Math.random() - 0.5) * canvas.width * 0.8;
        ...
        // Color varies between cyan and purple
